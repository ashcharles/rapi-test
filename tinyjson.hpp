...
#include	<boost/spirit/core.hpp> //<boost/spirit/include/classic_core.hpp> //<boost/spirit/core.hpp>
#include	<boost/spirit/utility/loops.hpp> //<boost/spirit/include/classic_loops.hpp> //<boost/spirit/utility/loops.hpp>
